...
- `git clone https://github.com/UniversalPropositions/UP_Spanish-AnCora.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Spanish-AnCora>/ --input_up=<up_path_to_UP_Spanish-AnCora>/ --output=<path_to_UD+UP_Spanish-AnCora>/`
